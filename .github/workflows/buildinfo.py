...
current_branch = subprocess.run(["git", "rev-parse", "--abbrev-ref", "HEAD"], stdout=subprocess.PIPE, text=True)
current_branch = current_branch.stdout.strip()
print ("\033[93;1;4mCurrent Branch         : " + current_branch + "\033[0m")
...
include_file.write("// ###   .github/workflows/main.yml for CI environment                    ###\n")
...
include_file.write("const char* buildInfo::branch           = \"" + current_branch + "\";\n")
